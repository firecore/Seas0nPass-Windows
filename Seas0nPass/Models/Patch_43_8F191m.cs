...
{
    public class Patch_43_8F191m : IPatch
    {
        private readonly string DMG_FILE_NAME = "038-0791-023.dmg";
        public readonly string ANOTHER_DMG_FILE_NAME = "018-7896-152.dmg";
        ...
        public string PerformPatch()
        {
            ...
            Utils.ExecuteResource("_43_010_decrypt_ramdisk");

            UpdateProgress(6);

            Utils.RecreateDirectory(Utils.TMP_FOLDER_PATH);

            File.Copy(Path.Combine(Directory.GetCurrentDirectory(), Utils.IPSW_FOLDER_PATH, DMG_FILE_NAME),
            ...
            Utils.ExecuteResource("_43_020_patch_asr");

            UpdateProgress(8);

            UpdateCurrentMessage("Encrypting ramdisk...");
            Utils.ExecuteResource("_43_030_encrypt_ramdisk");

            UpdateProgress(9);

            UpdateCurrentMessage("Decrypting file system...");
            Utils.ExecuteResource("_43_040_decrypt_filesystem");

            File.Copy(Path.Combine(Directory.GetCurrentDirectory(), Utils.IPSW_FOLDER_PATH, ANOTHER_DMG_FILE_NAME),
                      Path.Combine(Directory.GetCurrentDirectory(), Utils.TMP_FOLDER_PATH, Utils.OUR_BIG_DMG_FILE_NAME));

            Utils.ExecuteResource("_43_050_unpack_filesystem_image");

            UpdateProgress(49);

            UpdateCurrentMessage("Patching file system...");

            Utils.ExecuteResource("_43_060_patch_fstab");

            UpdateProgress(54);

            Utils.ExecuteResource("_43_061_patch_appletv");

            UpdateProgress(55);

            Utils.ExecuteResource("_43_062_patch_Services_plist");
            ...
            Utils.ExecuteResource("_43_080_add_cydia_to_image");

            UpdateProgress(177);

            Utils.ExecuteResource("_43_081_create_symlinks");

            Utils.ExecuteResource("_43_082_add_uncompress");

            Utils.ExecuteResource("_43_083_patch_status");

            UpdateProgress(179);

            UpdateCurrentMessage("Creating IPSW...");

            Utils.ExecuteResource("_43_090_pack_filesystem_image");
            ...
            Utils.ExecuteResource("_43_110_patch_dfu");
